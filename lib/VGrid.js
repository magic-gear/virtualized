...
class VGrid extends PureComponent {
  ...
  componentDidUpdate(prevProps) {
    ...
    if (dataSource !== prevProps.dataSource || loading !== prevProps.loading) {
      shouldRecompute = true
    }
                  ...
                  <div style={{ position: 'relative' }}>
                    {fixedColumnCount > 0 ? (
                      ...
                      >
                        ...
                        <div
                          style={{
                            width: fixedColumnWidth,
                            height: dataSource.length ? height - horizonScrollbarHeight : 0,
                            overflow: 'hidden',
                          }}
                        >
                          <Grid
                    ...
                    >
                      <Grid
                        ...
                        style={{
                          overflowX: !disableTitleScrollbar && dataSource.length ? 'auto' : 'hidden',
                        }}
                    ...
                    <div
                      style={{
                        height: dataSource.length ? height : 0,
                        width,
                      }}
                    >
                      <Grid
